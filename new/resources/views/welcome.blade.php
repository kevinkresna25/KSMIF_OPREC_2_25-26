<x-layouts.retro :showNav="true" :showFooter="true">
    ...
    <div class="relative bg-gradient-to-br from-bg-navbar via-bg-main to-bg-card border-b-4 border-text-glow/30 py-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="font-lato text-base sm:text-lg text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            <div class="mt-2 mb-12">
                ...
                <div class="flex items-center justify-center gap-4">
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/ksm_informatika" target="_blank" rel="noopener" aria-label="Instagram"
                       class="group inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/15 text-gray-300 hover:text-white hover:border-white/40 transition">
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 5a5 5 0 100 10 5 5 0 000-10zm0 2.5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm5.25-2.65a1.15 1.15 0 100 2.3 1.15 1.15 0 000-2.3z"/>
                        </svg>
                        <span class="sr-only">Instagram</span>
                    </a>
                    <!-- Website -->
                    <a href="https://ksminformatika.com" target="_blank" rel="noopener" aria-label="Website"
                       class="group inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/15 text-gray-300 hover:text-white hover:border-white/40 transition">
